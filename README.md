...
- Business endpoints ที่ต้องส่ง `x-api-key` เมื่อ `API_KEY_REQUIRED=true`: /categories, /gigs, /orders, /reviews, /admin
...
- มี pagination แบบ optional ในบาง endpoint (เช่น `/gigs`) ส่วน endpoint อื่นยังคงเป็น response แบบเรียบง่าย
